			...
			<div class="col-xs-8 col-xs-offset-4 col-md-8 col-md-4-offset">
				<div class="row">
					<div class="col-xs-6 col-md-6">
						<label for="tbxOldPassword" class="sr-only">Old Password</label>
		        		<input type="password" id="tbxOldPassword" class="form-control" placeholder="Old Password" required>
		        		<label for="tbxNewPassword" class="sr-only">New Password</label>
		        		<input type="password" id="tbxNewPassword" class="form-control" placeholder="New Password" required>
		        		<div class="row">
				        	<div class="col-xs-12 col-md-12">
				        		<label></label>
				        	</div>
				        </div>
				        <button class="btn btn-lg btn-primary btn-block" id="btnChangePassword">Change Password</button>
					</div>
				</div>
			</div>
		</div>
